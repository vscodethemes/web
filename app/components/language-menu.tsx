...
const icons: Record<(typeof languageValues)[0], JSX.Element> = {
  ...
  swift: (
    ...
    >
      <path
        fill="#f05138"
        d="M23.5 3h-15A3.5 3.5 0 0 0 5 6.5v19A3.5 3.5 0 0 0 8.5 29h15a3.5 3.5 0 0 0 3.5-3.5v-19C27 4.6 25.4 3 23.5 3"
      />
      <path
        d="m22.4 20.2-.1-.2-.2-.2-.1-.2-.1-.2-.1-.2v-.2h.1l.2.2.2.3.2.4.1.2v.2m-11.4 4.3s-1.7-.6-2.8-2.2c0 0 1.5 1 3.3 1.2 1.8.3 3.9 0 5.7-1.2h.1s-4-2.5-4.8-5.9c0 0 2.3 2.6 5 4 0 0-2.5-1.8-4.9-5.2 0 0-3.1-4.7-3.8-5.7 0 0 3.6 3.3 5.6 4.8 0 0-2.4-2.6-3.9-5 0 0 6.2 5.9 7.9 7.4 0 0 1.8 1.4 1.2 3.8 0 0 .5.2 1.2-.4 0 0 1.9-1.5 1.3-4.6 0 0-.7-3-2.8-5-2.1-2-2.7-3.9-2.7-3.9s3.3 1.7 4.6 5c1.1 3.2.8 4 .9 4.6 0 0 2-2.9.2-6.7-1.8-3.8-5-4.3-5-4.3s4.3 4.1 1.4 11.4c-2.9 7.2-7.9 6.6-7.9 6.6" fill="#fff"
      />
    </svg>
  ),
};
